写在最前面：感谢贾桐学长给我们留下第一版步兵的代码,从中我学到了非常多的东西

编译环境：
	IDE：
	1 Keilv5  ：直接用这个打开就能编译全部了
	2 CubeMX 6.3  ：用了CubeMX编译底层。
	硬件：
	1 RoboMaster开发板A板 STM32F427IIHx
	2 维特wt931陀螺仪，可以回传角度，角速度，角加速度，四元数，且反馈频率能到1000Hz，yaw轴少量零飘。
	软件架构：
